...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"services.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateService = exports.getService = exports.deleteService = exports.createService = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = "/pa-api/v1/services/".concat(slug);
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'DELETE',
              url: url
...
var getService = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _axios.default.get("/pa-api/v1/services/".concat(slug));
  ...
  return function getService(_x3) {
...
var updateService = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(slug, data) {
    var url, res;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"employees.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateEmployee = exports.getEmployee = exports.deleteEmployee = exports.createEmployee = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = "/pa-api/v1/employees/".concat(slug);
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'DELETE',
              url: url
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _axios.default.get("/pa-api/v1/employees/".concat(slug));
...
var updateEmployee = /*#__PURE__*/function () {
  ...
  return function updateEmployee(_x4, _x5) {
    return _ref4.apply(this, arguments);
  };
}();

exports.updateEmployee = updateEmployee;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"partners.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePartner = exports.getPartner = exports.deletePartner = exports.createPartner = void 0;
...
var createPartner = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(form) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
  ...
  return function createPartner(_x) {
    return _ref.apply(this, arguments);
  };
}();
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = "/pa-api/v1/partners/".concat(id);
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'DELETE',
              url: url
...
var getPartner = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _axios.default.get("/pa-api/v1/partners/".concat(id));
  ...
  return function getPartner(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
...
var updatePartner = /*#__PURE__*/function () {
  ...
  return function updatePartner(_x4, _x5) {
    return _ref4.apply(this, arguments);
  };
}();
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/pa-api/v1/users/updateMyPassword' : '/pa-api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
//-------- SELECTORS --------//
//---buttons
var createButton = document.querySelector('.btn-admin__create');
var deleteButton = document.querySelector('.btn-admin__delete');
var logOutBtn = document.querySelector('.nav__el--logout'); //---forms

var employeeForm = document.getElementById('form__employee-update');
var formEmployees = document.querySelector('.form__data--employees');
var formPartners = document.querySelector('.form__data--partners');
var formServices = document.querySelector('.form__data--services');
var loginForm = document.querySelector('.form--login');
var partnerForm = document.getElementById('form__partners-update');
var serviceForm = document.getElementById('form__service-update');
var userDataForm = document.querySelector('.form__data--user');
var userPasswordForm = document.querySelector('.form__data--password'); //---data cards

var employeeBox = document.querySelectorAll('.employees--card_Admin');
var partnerBox = document.querySelectorAll('.partners--card_Admin');
var serviceBox = document.querySelectorAll('.services--card_Admin'); //---form data

var employeeDesc = document.getElementById('form__employee-description');
var employeeEmail = document.getElementById('form__employee-email');
var employeeId = document.getElementById('form__employee-id');
var employeeImg = document.getElementById('form__employee-image');
var employeeImgToDisplay = document.getElementById('form__employee-imageToShow');
var employeeJob = document.getElementById('form__employee-job');
var employeeSlug = document.getElementById('form__employee-slug');
var employeeName = document.getElementById('form__employee-name');
var employeeRadioBtn = document.querySelectorAll('.form__employee-radio');
var employeeHide = document.getElementById('form__employee-hide');
var employeeShow = document.getElementById('form__employee-show');
var partnerId = document.getElementById('form__partners-id');
var partnerName = document.getElementById('form__partners-name');
var partnerLink = document.getElementById('form__partners-link');
var partnerImg = document.getElementById('form__partners-image');
var partnerImgToDisplay = document.getElementById('form__partners-imageToShow');
var serviceDesc = document.getElementById('form__service-description');
var serviceId = document.getElementById('form__service-id');
var serviceImg = document.getElementById('form__service-image');
var serviceImgToDisplay = document.getElementById('form__service-imageToShow');
var serviceSlug = document.getElementById('form__service-slug');
var serviceTitle = document.getElementById('form__service-title');
var svgItem = document.querySelectorAll('.svg');
var username = document.getElementById('form__user-name');
var userEmail = document.getElementById('form__user-email');
var userImg = document.getElementById('form__user-image');

var resetServiceForm = function resetServiceForm() {
  serviceForm.reset();
...
var resetEmployeeForm = function resetEmployeeForm() {
  employeeForm.reset();
...
var resetPartnerForm = function resetPartnerForm() {
  partnerForm.reset();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); //--------------------- DISPLAY Form -------------------------//
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return (0, _services.getService)(slug);

                case 3:
                  service = _context.sent;
                  formServices.classList.remove('hide');
                  serviceId.value = "".concat(service.id);
                  serviceId.dataset.hasid = "1";
                  serviceSlug.value = "".concat(service.slug);
                  serviceTitle.value = "".concat(service.title);
                  serviceDesc.value = "".concat(service.description);
                  serviceImgToDisplay.src = "/img/services/".concat(service.image);
  ...
  if (employeeBox) {
    for (var _i = 0; _i < employeeBox.length; _i++) {
      var _el = employeeBox[_i];

      _el.addEventListener('click', /*#__PURE__*/function () {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  slug = e.currentTarget.dataset.slug;
                  _context2.next = 3;
                  return (0, _employees.getEmployee)(slug);

                case 3:
                  employee = _context2.sent;
                  formEmployees.classList.remove('hide');
                  employeeDesc.value = "".concat(employee.description);
                  employeeEmail.value = "".concat(employee.email);
                  employeeId.value = "".concat(employee.id);
                  employeeId.dataset.hasid = "1";
                  employeeImgToDisplay.src = "/img/employees/".concat(employee.image);
                  employeeJob.value = "".concat(employee.jobTitle);
                  employeeSlug.value = "".concat(employee.slug);
                  employeeName.value = "".concat(employee.name);
  ...
  if (partnerBox) {
    for (var _i2 = 0; _i2 < partnerBox.length; _i2++) {
      var _el2 = partnerBox[_i2];

      _el2.addEventListener('click', /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
          ...
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  id = e.currentTarget.dataset.getid;
                  _context3.next = 3;
                  return (0, _partners.getPartner)(id);
                ...
                case 3:
                  ...
                  partnerImgToDisplay.src = "/img/partners/".concat(partner.image);
                  partnerName.value = "".concat(partner.name);
                  partnerLink.value = "".concat(partner.link);
                  console.log(id);
  ...
  if (createButton) createButton.addEventListener('click', function (e) {
    if (formServices) {
      resetServiceForm();
  ...
  if (formEmployees) {
    formEmployees.addEventListener('submit', /*#__PURE__*/function () {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                e.preventDefault();
                form = new FormData(formEmployees);
                ...
                for (_i3 = 0; _i3 < employeeRadioBtn.length; _i3++) {
                  if (employeeRadioBtn[_i3].checked === true) form.set('status', employeeRadioBtn[_i3].value);
                }
                ...
                _context4.next = 11;
                return (0, _employees.createEmployee)(form);
              ...
              case 13:
                slug = employeeSlug.value;
                _context4.next = 16;
                return (0, _employees.updateEmployee)(slug, form);
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  e.preventDefault();
                  slug = employeeSlug.value;
                  confirmation = confirm("Etes-vous sur de vouloir supprimer cette fiche?");
                  ...
                  _context5.next = 6;
                  return (0, _employees.deleteEmployee)(slug);
  ...
  if (formPartners) {
    formPartners.addEventListener('submit', /*#__PURE__*/function () {
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                e.preventDefault();
                form = new FormData(formPartners);
                ...
                _context6.next = 8;
                return (0, _partners.createPartner)(form);
              ...
              case 10:
                ...
                console.log(id);
                _context6.next = 14;
                return (0, _partners.updatePartner)(id, form);
            ...
            while (1) {
              switch (_context7.prev = _context7.next) {
                case 0:
                  e.preventDefault();
                  id = partnerId.value;
                  confirmation = confirm("Etes-vous sur de vouloir supprimer ce partenaire?");
                  ...
                  _context7.next = 6;
                  return (0, _partners.deletePartner)(id);
  ...
  if (formServices) {
    formServices.addEventListener('submit', /*#__PURE__*/function () {
        ...
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                e.preventDefault();
                form = new FormData(formServices);
                ...
                _context8.next = 8;
                return (0, _services.createService)(form);
              ...
              case 10:
                ...
                _context8.next = 13;
                return (0, _services.updateService)(slug, form);
            ...
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
                  e.preventDefault();
                  slug = serviceSlug.value;
                  confirmation = confirm("Etes vous sur de vouloir supprimer ce service?");
                  ...
                  _context9.next = 6;
                  return (0, _services.deleteService)(slug);
...
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./login":"login.js","./services":"services.js","./employees":"employees.js","./partners":"partners.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
